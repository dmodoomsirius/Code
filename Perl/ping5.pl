...
#Programs assumes a class C address (w.x.y.z) where w.x.y is the netwrok portion of the IP 
...
my $my_IP = '172.16.45.105'; #Use this address in microsoft "net send" command
